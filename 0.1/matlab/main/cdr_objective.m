...
Q_UPPER_LIMIT = STACKMIN;   % upper limit - transition from zero energy to quadratic increase 
Q_LOWER_LIMIT = 0;          % lower limit - transition from quadratic to zero energy
Q_RATE = 2;                 % rate of increase in energy 
